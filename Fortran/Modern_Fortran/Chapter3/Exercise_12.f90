...
module Vec2d_class
  ...
  type, public :: Vec2d ! DT explicitly declared "public"
   ...
   contains
     ...
     procedure, public :: setU => initUVec2d
     procedure, public :: setV => initVVec2d
...
contains
  ...
  subroutine initUVec2d( this, u )
    class(Vec2d), intent(inout) :: this
    real, intent(in) :: u
    this%mU=u
  end subroutine initUVec2d

  subroutine initVVec2d( this, v )
    class(Vec2d), intent(inout) :: this
    real, intent(in) :: v
    this%mV=v
  end subroutine initVVec2d
