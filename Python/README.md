...
14. [nbextensions](https://jupyter-contrib-nbextensions.readthedocs.io/en/latest/install.html), [nbterm](https://blog.jupyter.org/nbterm-jupyter-notebooks-in-the-terminal-6a2b55d08b70), [nbzip](https://github.com/data-8/nbzip) (Plus `--user` to overcome permission issues.)
15. `Close and Halt` can now be defined as shortcut in `Edit Command mode Shortcuts`.
